...
class DiCoSA(nn.Module):
    ...
    def forward(self, text_ids, text_mask, video, video_mask=None, idx=None, global_step=0):
        ...
        if self.training:
            ...
            # M_t2v_logits += self.config.loss2_weight * score2
            # M_v2t_logits += self.config.loss2_weight * score2.T
            ...
            loss = M_loss + Inter_Diversity + Intra_Consistency
            ...
            # loss = M_loss + self.config.loss2_weight * Score_2_loss + Intra_Consistency + Inter_Diversity
